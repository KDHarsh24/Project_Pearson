...
export default function DocumentUploadPage() {
  ...
  return (
    <>
      <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-blue-50/30 flex flex-col w-full">
        {/* Background Pattern */}
        ...
        <div className="flex-1 relative">
          ...
          <div className="max-w-full sm:max-w-2xl md:max-w-3xl lg:max-w-4xl mx-auto px-4 sm:px-6 py-6 sm:py-8 w-full">
            ...
            <div className="mb-8 sm:mb-12">
              <div className="relative bg-white/80 backdrop-blur-sm border border-white/20 rounded-2xl sm:rounded-3xl p-6 sm:p-8 shadow-xl shadow-blue-500/10">
                {/* Decorative Elements */}
                <div className="absolute top-0 right-0 w-32 h-32 bg-gradient-to-br from-blue-500/10 to-indigo-600/10 rounded-full blur-3xl" />
                ...
                <div className="relative flex flex-col sm:flex-row items-center sm:items-start gap-4 sm:gap-6">
                  ...
                  <div className="relative group">
                    <div className="absolute inset-0 bg-gradient-to-r from-blue-600 to-indigo-600 rounded-full blur-lg opacity-75 group-hover:opacity-100 transition-opacity duration-300" />
                  ...
                  <div className="flex-1 text-center sm:text-left">
                    ...
                    <p className="text-slate-600 leading-relaxed mb-4">
                      <span className="font-semibold text-blue-700">Your AI Legal Assistant</span> is ready to help you analyze documents, 
                    ...
                    <div className="flex flex-wrap gap-2 justify-center sm:justify-start">
                      {['Document Analysis', 'Contract Review', 'Case Strategy', 'Legal Research'].map((feature, idx) => (
                        <span 
                          key={feature}
                          className="inline-flex items-center gap-1 px-3 py-1 bg-blue-50 text-blue-700 rounded-full text-xs font-small border border-blue-200 hover:bg-blue-100 transition-colors duration-200"
                        >
            ...
            <div className="mb-6 sm:mb-8">
                ...
                <select
                  ...
                  className="w-full sm:w-auto px-4 py-3 bg-white border border-slate-200 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent shadow-sm hover:border-slate-300 transition-all duration-200"
                >
                  ...
                  <div className="space-y-2">
                    {uploadedDocsMeta.map((doc, idx) => (
                      <div 
                        ...
                        className="group flex items-center justify-between p-3 bg-gradient-to-r from-emerald-50 to-blue-50 border border-emerald-200/50 rounded-lg hover:shadow-md transition-all duration-200"
                      >
